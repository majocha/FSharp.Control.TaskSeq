...
module TaskExtensions =
    ...
    type TaskBuilderBase with
        ...
        member inline _.WhileAsync([<InlineIfLambda>] condition: unit -> ValueTask<bool>, [<InlineIfLambda>] body: TaskCode<_, unit>) : TaskCode<_, _> =
        ...
        member inline this.For(source: TaskSeq<'T>, [<InlineIfLambda>]  body: 'T -> TaskCode<_, unit>) : TaskCode<_, unit> =
